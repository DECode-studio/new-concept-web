...
const DashboardView = observer(() => {
  ...
  return (
    <div className="space-y-10 text-[#3d2a13]">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs text-[#9c7611]/70">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white px-3 py-2 shadow-sm">
              <GraduationCap className="h-3.5 w-3.5 text-[#FFB300]" />
              {student?.programId ? "Program enrolled" : "Program assignment pending"}
            </span>
            <span className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white px-3 py-2 shadow-sm">
              <CalendarCheck className="h-3.5 w-3.5 text-[#FFB300]" />
      ...
      <section className="grid gap-6 md:grid-cols-[1.2fr_1fr]">
        <Card className="rounded-[28px] border border-white/50 bg-white text-[#3d2a13] shadow-[0_30px_60px_-45px_rgba(61,42,19,0.14)]">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-semibold text-[#3d2a13]">My Profile</CardTitle>
            <p className="text-xs text-[#9c7611]/70">These details personalise your learning experience.</p>
          </CardHeader>
          <CardContent className="grid gap-5 md:grid-cols-2">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#9c7611]/70">Full name</p>
              <p className="mt-2 text-sm font-semibold text-[#3d2a13]">{student?.fullName ?? "-"}</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#9c7611]/70">Registration</p>
              <p className="mt-2 font-mono text-sm font-semibold text-[#3d2a13]">{student?.registrationNumber ?? "-"}</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#9c7611]/70">Status</p>
              <div className="mt-2">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#9c7611]/70">Branch</p>
              <p className="mt-2 text-sm font-semibold text-[#3d2a13]">{student?.branchId ?? "-"}</p>
            </div>
            <div className="md:col-span-2">
              <p className="text-xs uppercase tracking-[0.3em] text-[#9c7611]/70">Program</p>
              <p className="mt-2 text-sm font-semibold text-[#3d2a13]">{student?.programId ?? "-"}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-[28px] border border-white/50 bg-white text-[#3d2a13] shadow-[0_30px_60px_-45px_rgba(61,42,19,0.14)]">
          <CardHeader className="pb-2">
            <CardTitle className="text-base font-semibold text-[#3d2a13]">Upcoming highlights</CardTitle>
            <p className="text-xs text-[#9c7611]/70">Stay prepared and keep your streak alive.</p>
          </CardHeader>
          <CardContent className="space-y-4 text-sm text-[#9c7611]/70">
            <div className="rounded-3xl border border-white/60 bg-white/95 p-4 text-[#3d2a13] shadow-sm">
            ...
            <Button
              variant="ghost"
              className="h-10 w-full rounded-2xl border border-[#FFB300]/35 bg-[#FFB300]/10 px-5 text-xs text-[#3d2a13] hover:bg-[#FFB300]/20"
            >
              View full agenda
            </Button>
          </CardContent>
      ...
      <section>
        <h2 className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#9c7611]/70">
          Quick launch
        </h2>
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {quickLinks.map(({ icon: Icon, title, description }) => (
            <Button
              key={title}
              variant="ghost"
              className="h-36 flex-col items-start justify-start gap-3 rounded-[28px] border border-white/50 bg-white/95 p-6 text-left text-sm font-semibold text-[#3d2a13] shadow-[0_25px_55px_-35px_rgba(61,42,19,0.12)] hover:bg-white/90"
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-white/70 bg-[#FFB300]/10 text-[#FFB300]">
                <Icon className="h-5 w-5" />
              </div>
              <span>{title}</span>
              <span className="text-xs font-normal text-[#9c7611]/70">{description}</span>
            </Button>
          ))}
        </div>
      </section>
