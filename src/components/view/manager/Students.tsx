...
import { TblProgram, TblClass, TblLevel, TblChargeFee, StudentStatus, UserTitle, UserGender, UserBloodGroup, MethodRequest } from "@/models/types";
...
export const ManagerStudents = observer(() => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setOpen(false);
    setFormData({
      programId: "", classId: "", levelId: "", chargeId: "", fullName: "", 
      nickName: "", phone: "", email: "", address: "", gender: UserGender.MALE, status: StudentStatus.ACTIVE
    });
  };
              ...
              <TableBody>
                {students.map((student) => (
                  <TableRow key={student.id}>
                    ...
                    <TableCell>
                      {new Date(student.studyStartTime).toLocaleDateString()}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
